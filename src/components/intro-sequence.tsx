        ...
        <div
          ...
          className={`absolute flex flex-col items-center transition-all ${
            step === index 
              ...
              : step > index 
                ? "opacity-0 scale-125 blur-[100px] -translate-y-32" // Fly out up
                : "opacity-0 scale-75 blur-[100px] translate-y-32" // Fly in from bottom
          }`}
        >
          {stmt.isLogo && (
            <div className="relative mb-8">
              <div className="absolute inset-0 bg-primary/30 blur-[120px] rounded-full scale-[2] animate-pulse" />
